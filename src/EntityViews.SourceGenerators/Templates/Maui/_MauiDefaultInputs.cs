...
{{
    ...
    {{
        ...
        {{
            ...
            _validationBorder.WidthRequest = Width;
        }};
    ...
    public static readonly BindableProperty InputValidationErrorColorProperty =
        BindableProperty.Create(
            ...
            declaringType: typeof(EntityViewsInput<TInput, THandler>), defaultValue: Color.FromRgba(239, 154, 154, 255),
            propertyChanged: (BindableObject bindable, object oldValue, object newValue) =>
            {{
                var input = (EntityViewsInput<TInput, THandler>)bindable;
                if (!input._isInitialized) return;
    ...
    {{
        ...
        _activeBoxView.BackgroundColor = InputValidationErrorColor;
    ...
    {{
        ...
        _activeBoxView.BackgroundColor = HighlightColor;
